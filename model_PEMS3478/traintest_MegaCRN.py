...
from utils import masked_mae, StandardScaler, getDayTimestamp_
...
parser.add_argument('--dataset', type=str, choices=['PEMS03', 'PEMS04', 'PEMS07', 'PEMS08'], default='PEMS03', help='which dataset to run')
parser.add_argument('--trainval_ratio', type=float, default=0.8, help='the ratio of training and validation data among the total')
parser.add_argument('--val_ratio', type=float, default=0.25, help='the ratio of validation data among the trainval ratio') # this makes train:valid:test 6:2:2
...
parser.add_argument("--patience", type=float, default=200, help="patience used for early stop")
