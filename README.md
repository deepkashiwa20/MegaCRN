...
#### Arguments (EXPY-TKY)
The hyperparameters for PEMS03,04,07,08 in model_PEMS3478/traintest_MegaCRN.py are the same as the above except the following. 
...
* argument('--val_ratio', type=float, default=0.25, help='the ratio of validation data among the trainval ratio') # this makes train:valid:test=3:1:2
